...
3. Update `frontendResourcePlan` when JavaScript, React LLD, HLD, LearnersBucket, Namaste FSD, or Patterns.dev links change.
4. Keep `bonusTopics` optional and untracked unless the product requirement explicitly changes.
5. Update `ai/prd.md`, `ai/api-contract.md`, and `ai/architecture.md`.
6. Keep the weekly plan commitment-first; do not make the full 243-item question bank the primary flow.
